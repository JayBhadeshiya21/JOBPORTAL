  ...
  return (
    <section className="pt-24 pb-16 bg-white min-h-screen flex items-center">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.h1
            ...
            className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-60 leading-tight pt-10"
          >
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="bg-white border-2 border-gray-200 text-gray-700 px-8 py-4 rounded-xl font-semibold text-lg hover:border-gray-300 hover:border-gray-50 transition-all duration-300 shadow-sm hover:shadow-sm"
              onClick={() => {
                navigate(
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-blur-50 to-purple-50 rounded-full blur-3xl opacity-20 " />
      </div>
    </section>
  );
}
