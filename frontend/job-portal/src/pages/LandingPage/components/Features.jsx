...
function Features() {
  return (
    <section className='py-20 bg-white relative overflow-hidden'>
        <div className='contain mx-auto px-4 relative z-10 '>
            <div className='text-center mb-16'>
                <h2 className='text-4xl md:text5xl font-bold text-gray-900 mb-6'>
                    Every you Need to 
                ...
                <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
                    Whether your're looking for your next oppertunity or the perfect
            ...
            <div className='grid md:grid-cols-2 gap-16 lg:gap-24'>
                ...
                <div>
                    <div className='text-center mb-12'>
                        ...
                        <div className="w-24 h-2 bg-gradient-to-r from-blue-500 to-blue-600 mx-auto rounded-full "/>
                    </div>
