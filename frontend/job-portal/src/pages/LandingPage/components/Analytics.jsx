...
import { TrendingUp, Users, Briefcase, Target, icons, TurkishLira } from 'lucide-react'
        ...
        <div className="container mx-auto px-4 ">
            ...
            >
                ...
                <p className="text-xl text-gray-600 max-w-3xl mx-auto ">
                    Real-time insights and data-driven results that showcase the power of our platform in connecting talent with oppertunitys. 
                </p>
            </motion.div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16 '>
                {stats.map(( stat, index) => (
                     <motion.div
                        ...
                        initial={{ opacity: 0, y: 30}}
                        whileInView={{ opacity: 1, y: 0}}
                        transition={{ deley: index * 0.1, duration: 0.6}}
                        viewport={{ once: true}}
